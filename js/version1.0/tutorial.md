...
With this section complete, you're ready to move on to the tutorial for [version 2.0](https://github.com/rooftop-media/ktty-tutorial/blob/main/js/version2.0/tutorial.md)!
